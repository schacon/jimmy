            ...
            VStack(alignment: .leading, spacing: 6) {
                HStack {
                    Image(systemName: "checkmark.circle")
                        .foregroundColor(.green)
                        .font(.caption)
                    Text("\(weeksWithFivePlusDrinkFreeDays)/\(isCurrentMonth ? elapsedWeeksInCurrentMonth : totalWeeksInRange) weeks")
                        .font(.caption2)
                        .fontWeight(.medium)
                }
            ...
            VStack(alignment: .leading, spacing: 6) {
                HStack {
                    Image(systemName: "thermometer.medium")
                        ...
                        .font(.caption)
                    Text("\(weeksWithThreePlusSaunaDays)/\(isCurrentMonth ? elapsedWeeksInCurrentMonth : totalWeeksInRange) weeks")
                        .font(.caption2)
                        .fontWeight(.medium)
                }
